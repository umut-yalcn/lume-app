TRANSLATIONS = {
    "en": {
        ...
        "select": "Select",
        "supports": "Supports: JPG, PNG, WEBP, HEIC, TIFF, GIF, BMP, RAW (DNG/CR2/NEF/ARW/ORF), MP4, MOV, AVI, MKV and more",
        ...
        "warn_nested_folder": "The target folder overlaps the folder the files come from. Choose a separate target folder.",
        "warn_file_limit": "⚠️ Maximum 10,000 files allowed.",
    ...
    "tr": {
        ...
        "select": "Seç",
        "supports": "Desteklenen: JPG, PNG, WEBP, HEIC, TIFF, GIF, BMP, RAW (DNG/CR2/NEF/ARW/ORF), MP4, MOV, AVI, MKV ve daha fazlası",
        ...
        "warn_nested_folder": "Hedef klasör, dosyaların bulunduğu klasörle iç içe. Ayrı bir hedef klasör seçin.",
